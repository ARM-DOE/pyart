...
def test_vad_michelson():
    ...
    vad_speed = [4.9997, 4.9445, 4.8865, 4.8182, 4.7497]
    vad_direction = [89.8712, 90.5113, 91.2084, 92.0622, 92.9569]
    u_wind = [-4.9997, -4.9443, -4.8854, -4.8150, -4.7434]
    v_wind = [-0.0112, 0.0441, 0.1030, 0.1733, 0.2450]
