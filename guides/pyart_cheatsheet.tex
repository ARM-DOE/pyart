...
\documentclass[potrait,a0paper,fontscale=0.33]{baposter} % Adjust the font scale/size here
...
% Installation
%------------------------------------------------
\headerbox{Installation}{name=installation,column=0,row=.257,span=1}{
...
% Contact Information
%------------------------------------------------
\headerbox{Contact Information}{name=contact information,column=0,row=.578,span=1}{
...
\begin{flushleft}
\textbf{Issues:}
https://github.com/ARM-DOE/pyart/issues
\end{flushleft}
...
\headerbox{Getting Started}{name=getting started,column=0,row=.72}{
...
\headerbox{Reading and Writing Data}{name=reading and writing data,column=0,row=.785}{
...
\headerbox{Graphing Data}{name=graphing data,column=1,row=.474}{
\begin{flushleft}
\begin{tabular}{@{}ll@{}}
...
\headerbox{Mapping Data}{name=mapping data,column=1,row=.859}{
\begin{flushleft}
\begin{tabular}{@{}ll@{}}
...
\headerbox{Corrections}{name=corrections,column=2,span=1,row=0}{
\begin{flushleft}
...
based on a set of condition typically based on the\\
values in the radar fields.\\
\\
...
\headerbox{Retrievals}{name=retrievals,column=2,span=1,row=.497}{
\begin{flushleft}
...
$>$$>$$>$ pyart.utils.texture\_along\_ray(\\
...
\headerbox{References}{name=references,column=1,row=0,span=1}{
