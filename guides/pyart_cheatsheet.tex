...
% Contact Information
%------------------------------------------------
\headerbox{Contact Information}{name=contact information,column=0,row=.577,span=1}{
...
\headerbox{Getting Started}{name=getting started,column=0,row=.705}{
...
\headerbox{Reading and Writing Data}{name=reading and writing data,column=0,row=.771}{
