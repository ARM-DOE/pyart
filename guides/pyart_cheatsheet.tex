...
% Installation
%------------------------------------------------
\headerbox{Installation}{name=installation,column=0,row=.266,span=1}{

\begin{flushleft}
\begin{tabular}{@{}ll@{}}
The recommended way to install Py-ART is by\\
installing Anaconda or Miniconda, then create\\
an environment and activate it:\\
\\
\-\hspace{0.4cm} $\bullet$ Then create a conda environment:\\
\-\hspace{0.4cm} \$ conda create -n pyart python=3.9\\
\\
\-\hspace{0.4cm} $\bullet$ Activate the Py-ART environment:\\
\-\hspace{0.4cm} \$ conda activate pyart\\
\\
...
need to get the latest main branch from github.com\\
\\
\-\hspace{0.1cm} $\bullet$ Clone the Py-ART repository and go into the\\
\-\hspace{0.3cm} directory:\\
\-\hspace{0.1cm} \$ git clone git@github.com:ARM-DOE/pyart.git\\
...
% Contact Information
%------------------------------------------------
\headerbox{Contact Information}{name=contact information,column=0,row=.559,span=1}{
...
\headerbox{Getting Started}{name=getting started,column=0,row=.681}{

\begin{flushleft}
\textbf{Cookbooks for Getting Started:}
...
\headerbox{Reading and Writing Data}{name=reading and writing data,column=0,row=.779}{
...
$>$$>$$>$ std\_dev = pyart.util.interval\_std(\\
\-\hspace{1.5cm} dist, interval\_min, interval\_max)\\
\-\hspace{0.4cm} $\bullet$ Compute the standard deviation of a distribution\\
