#!/usr/bin/env python
# script to test map_to_grid function, creates figure_map_to_grid_slow.png
...
def test_map_to_grid_slow():
    ...
    fig.savefig('figure_map_to_grid_slow.png')

if __name__ == "__main__":
    test_map_to_grid_slow()
