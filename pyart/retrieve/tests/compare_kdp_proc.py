...
def compare_kdp_estimation_methods():
    ...
    # Maesaka method
    kdp_dict_mae, phidpf_dict_mae, phidpr_dict_mae = kdp_proc.kdp_maesaka(
       prof_psidp, maxiter=1000, check_outliers=False)
    ...
    plt.plot(ranges,kdp_dict_mae['data'][0])
    plt.plot(ranges,kdp_dict_vulp['data'][0])
    ...
    phidp_dict_mae = 0.5 * (phidpf_dict_mae['data'][0] + 
                            phidpr_dict_mae['data'][0])
    plt.plot(ranges,phidp_dict_mae)
    plt.plot(ranges,phidp_dict_vulp['data'][0])
    plt.plot(ranges,phidp_dict_schnee['data'][0])
