...
static PyMethodDef __pyx_mdef_5pyart_2io_18nexrad_interpolate_1_fast_interpolate_scan = {"_fast_interpolate_scan", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_5pyart_2io_18nexrad_interpolate_1_fast_interpolate_scan, METH_VARARGS|METH_KEYWORDS, __pyx_doc_5pyart_2io_18nexrad_interpolate__fast_interpolate_scan};
static PyObject *__pyx_pw_5pyart_2io_18nexrad_interpolate_1_fast_interpolate_scan(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_scratch_ray)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("_fast_interpolate_scan", 1, 7, 7, 1); __PYX_ERR(0, 6, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_fill_value)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_fast_interpolate_scan", 1, 7, 7, 2); __PYX_ERR(0, 6, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_start)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_fast_interpolate_scan", 1, 7, 7, 3); __PYX_ERR(0, 6, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_end)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_fast_interpolate_scan", 1, 7, 7, 4); __PYX_ERR(0, 6, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_moment_ngates)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_fast_interpolate_scan", 1, 7, 7, 5); __PYX_ERR(0, 6, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_linear_interp)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_fast_interpolate_scan", 1, 7, 7, 6); __PYX_ERR(0, 6, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_fast_interpolate_scan") < 0)) __PYX_ERR(0, 6, __pyx_L3_error)
      }
  ...
  __Pyx_RaiseArgtupleInvalid("_fast_interpolate_scan", 1, 7, 7, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 6, __pyx_L3_error)
  __pyx_L3_error:;
 ...
 *         int start, int end, int moment_ngates, int linear_interp):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5pyart_2io_18nexrad_interpolate_1_fast_interpolate_scan, NULL, __pyx_n_s_pyart_io_nexrad_interpolate); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_fast_interpolate_scan, __pyx_t_1) < 0) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
